"""Single-pass Data Quality Evaluation observations over already-admitted Versioned Data Artifact/Cross-source Entity Alignment data."""
...
def observe_quality(
    ...
    """Aggregate every Versioned Data Artifact outcome once into field, row and dataset counters."""
    ...
    for row in candidate.rows:
        ...
        for outcome in row.fields:
            ...
            if isinstance(outcome, MappedCanonicalValue):
                ...
                raise ValueError("unsupported Versioned Data Artifact canonical outcome")
