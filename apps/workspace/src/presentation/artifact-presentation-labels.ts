...
const ARTIFACT_KIND_DESCRIPTIONS = {
  ...
  analysis_report: "汇总受控科学技能的结果、指标、发现与限制。",
  visualization: "展示图表、FITS 图像、天球场景或模型诊断。",
  spectrum: "展示波长、通量、连续谱与检测到的谱线。",
  light_curve: "展示时间序列、质量筛选与周期分析结果。",
  model_evaluation: "记录训练方案、数据划分、指标与基线对照。",
  model_artifact: "保存可下载、可复现并受状态治理的 ONNX 模型。",
