...
- `generated/phase0` 同步导出 C-04 的 build input/result、三类 typed candidate、MappingRuleSet 与 UnitConversionCatalog；这些 Schema 是 Pipeline Contract，不会因此成为 HTTP DTO 或数据库记录。
