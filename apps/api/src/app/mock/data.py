...
def mock_dataset() -> DatasetResponse:
    return DatasetResponse(
        ...
        columns=[
            ColumnInfo(name="pl_orbper", label="Orbital Period", unit="day", source_ids=["source_nasa_exoplanet_archive"], missing_rate=0.08),
            ColumnInfo(name="pl_rade", label="Planet Radius", unit="R_earth", source_ids=["source_nasa_exoplanet_archive"], missing_rate=0.12),
            ColumnInfo(name="pl_bmass", label="Planet Mass", unit="M_earth", source_ids=["source_nasa_exoplanet_archive"], missing_rate=0.25),
            ColumnInfo(name="hostname", label="Host Star Name", unit="", source_ids=["source_nasa_exoplanet_archive"], missing_rate=0.0),
            ColumnInfo(name="st_teff", label="Stellar Effective Temperature", unit="K", source_ids=["source_nasa_exoplanet_archive"], missing_rate=0.05),
        ],
        rows=[
        ...
        quality_score=QualityScore(field_coverage=0.86, source_completeness=1.0, unit_consistency=1.0),
    )
