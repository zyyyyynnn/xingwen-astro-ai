...
- FastAPI `/api/v1` 回归接口和 `/api/v2` Contract；Session 与 Workspace/Share runtime Current，其余 v2 runtime Pending；
...
| `api`       | Python 3.13 + uv               | FastAPI `/api/v1`；`/api/v2` Contract 与 Session/Workspace/Share runtime |
