    ...
    >
      ...
      {hasInspector && isNarrow ? (
        ...
        >
          ...
          >
            <SheetHeader className="research-inspector-sheet__header h-[var(--workspace-header-block-size)] shrink-0 ps-[var(--space-5)] pe-[var(--workspace-header-control-reserve-inline)]">
              {inspectorToolbar ?? (
