...
export function ChatInputField({
  ...
  return (
    <div className="min-w-0 flex-1">
      <div
        ref={chatInputRef}
        className="chat-input min-h-5 max-h-[calc(15rem-2.5rem)] overflow-y-auto whitespace-pre-wrap bg-transparent text-sm leading-5 text-[var(--oh-text)] outline-none"
