...
| `/api/v1` Phase 0 DTO 字段和不变量      | [Phase 0 Data Model](architecture/DATA_MODEL_V1.md) |
| `/api/v1` Schema 字段映射和偏差决策     | [Phase 0 Schema Matrix](architecture/V1_SCHEMA_FIELD_MATRIX.md) |
