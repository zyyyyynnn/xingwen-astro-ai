...
| R-10 | Medium   | 数据 crossmatch 或单位规则错误         | 匹配冲突率高、单位不可转换、误差/limit 丢失          | 版本化 RuleSet、27 场景 Benchmark、显式审查绑定、冲突保留与双方 Evidence；字段合并和质量评分保持独立边界 | 冻结 Benchmark 与相关回归测试通过 |
