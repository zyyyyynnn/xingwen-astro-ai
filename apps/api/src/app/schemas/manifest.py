    ...
    def validate_registry_references(self) -> Self:
        ...
        for field in self.fields:
            ...
            for document_alias in field.document_aliases:
                ...
                owner_key = (field.object_type.value, document_alias.alias)
...
def normalize_document_alias_label(label: str) -> str:
    """Normalize non-authoritative document tokens such as declared nulls.

    Field association deliberately does not call this helper: canonical field
    ids and registered document aliases use exact string equality.
    """
