...
GitHub Open Issues 是标题、正文、标签、Milestone、负责人和实时状态的唯一来源。本文只维护 `ID / Role / Issue title / Owner / Dependency / Deliverable`，不复制验收清单、状态历史或完成百分比。
...
| ID  | Role | Issue title                                                        | Owner | Dependency            | Deliverable                                               |
| --- | ---- | ------------------------------------------------------------------ | ----- | --------------------- | --------------------------------------------------------- |
...
| #28 | Epic | [B] B-04 Epic：建立 /api/v2 最小领域与传输契约                    | B     | #2、#80、#81、#82     | 核心 Contract、Session 安全、Workspace/Share               |
| #80 | Task | [B] B-15 冻结 /api/v2 核心领域与传输契约                          | B     | #2、#4、#28           | Project、Contract、Run、Event、Artifact、Version Contract  |
| #81 | Task | [B] B-16 实现 Session、ownership、CSRF 与统一写入安全边界         | B     | #80、#28              | Session、授权、幂等、Problem Details                       |
| #82 | Task | [B] B-17 实现 WorkspaceSnapshot、ShareSnapshot 与公开只读投影     | B     | #80、#81、#28         | Workspace 恢复、冻结分享、撤销与过期                       |
| #29 | Epic | [A] A-02 Epic：建立品牌视觉系统与静态工作台框架                   | A     | #84、#85、#86         | Design System、Visual Engine、静态 Site/Workspace Shell    |
| #84 | Task | [A] A-11 建立 Design Token、UI primitive 与 BrandMark             | A     | #3、#29               | 共享 Token、primitive、BrandMark                           |
| #85 | Task | [A] A-12 实现 Visual Engine 生命周期、质量档与降级                | A     | #3、#29               | deterministic runtime、资源释放、Poster/Reduced Motion     |
| #86 | Task | [A] A-13 组装 Brand Site 与静态 Workspace Shell                   | A     | #84、#85、#29         | 静态首页、Workspace Shell、a11y 与降级                     |
| #30 | Epic | [A] A-03 Epic：建立契约驱动的工作台行为层                         | A     | #28、#29、#87、#88、#89 | Domain/Fixture、HTTP Adapter、Workspace/Share 行为          |
| #87 | Task | [A] A-14 建立前端 Domain、Fixture Adapter 与 Guided Tour FSM      | A     | #80、#30              | 稳定 Domain、版本化 Fixture、FSM、基础 provenance 状态     |
| #88 | Task | [A] A-15 接入 Session、Contract、Run 与 Event HTTP Adapter        | A     | #81、#87、#30         | 生成 Contract Adapter、Mapper、Event 恢复                  |
| #89 | Task | [A] A-16 绑定 WorkspaceSnapshot、Share 与静态 Shell 行为          | A     | #82、#86、#88、#30    | Workspace 恢复、只读分享与 Shell 行为                      |
...
| #33 | Epic | [C] C-03 Epic：完成补充来源与跨源实体对齐                       | C     | #32、#90、#91              | 补充来源、crossmatch、匹配 Evidence                 |
| #90 | Task | [C] C-07 接入补充数据源 Adapter 与 SourceSnapshot               | C     | #2、#32、#33               | 补充来源查询和独立 SourceSnapshot                   |
| #91 | Task | [C] C-08 实现跨源实体对齐、匹配 Evidence 与审查基准             | C     | #32、#90、#33              | crossmatch 规则、冲突保留、人工审查指标             |
| #34 | Task | [C] C-04 实现版本化字段映射、单位统一与数据 Artifact            | C     | #32、#33                   | Dataset、FieldDictionary、Evidence、规则版本/hash    |
...
| ID  | Role | Issue title                                                          | Owner | Dependency                  | Deliverable                                            |
| --- | ---- | -------------------------------------------------------------------- | ----- | --------------------------- | ------------------------------------------------------ |
| #44 | Epic | [D] D-04 Epic：完成 Claim、Relation 与 ReasoningTrace 准入          | D     | #6、#41、#92、#93         | Claim、Relation/Trace 准入与 Benchmark                 |
| #92 | Task | [D] D-07 实现 LiteratureClaim 抽取、Evidence 准入与评测             | D     | #6、#41、#44              | Claim candidate、Evidence、Prompt/hash 和评测          |
| #93 | Task | [D] D-08 实现 Relation、ReasoningTrace 准入与评测                   | D     | #6、#92、#44              | candidate/accepted/rejected Relation、Trace 与评测     |
...
| ID  | Role | Issue title                                                    | Owner | Dependency                                                                                   | Deliverable                                      |
| --- | ---- | -------------------------------------------------------------- | ----- | -------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| #62 | Gate | [X] X-06 Gate：验证 v2 数据、论文与 Summary 主链路            | X     | #31、#76、#77、#78、#83、#32、#33、#34、#35、#38、#41、#36、#39、#42、#37、#40、#43 | 固定 Live Run、Artifact/Evidence 与 M2.1 退出结论 |
| #63 | Gate | [X] X-07 Gate：验证推理与证据图谱 Artifact 闭环                | X     | #62、#77、#78、#83、#44、#92、#93、#47、#45、#48、#46、#49                            | 推理/Graph Benchmark、E2E 与 M2.2 退出结论        |
