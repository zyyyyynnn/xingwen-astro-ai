...
import { CollapsibleRationale } from "../components/conversation-events/chat/event-message-components/collapsible-thinking";
  ...
  return (
    ...
    >
      <button
        ...
        onClick={() => setIsRightPanelShown((shown) => !shown)}
      >
