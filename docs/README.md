...
| 查项目边界                                     | [../PRD.md](../PRD.md), [../DESIGN.md](../DESIGN.md)                                                                             |
| 查产品设计总纲、体验域、系统边界与专项规范入口 | [../DESIGN.md](../DESIGN.md)                                                                                                     |
| 查模块职责                                     | [architecture/MODULES.md](architecture/MODULES.md)                                                                               |
| 查当前前端架构                                 | [architecture/FRONTEND_ARCHITECTURE.md](architecture/FRONTEND_ARCHITECTURE.md)                                                   |
...
| 文档层级、状态与归档规则                       | [DOCUMENTATION_GOVERNANCE.md](DOCUMENTATION_GOVERNANCE.md)                                                                       |
...
- 涉及交付状态的文档必须使用 Current / Implemented / Pending，并与代码和运行证据一致。
- 未实现能力只能写为规划、预留或后续扩展。
- 第三方参考资料不构成项目规范；规范性事实只能写入上表对应的唯一正文来源。
