"""Deterministic demo fixture built by the paper-acquisition pipeline.
...
TypeScript. It drives the real ``PaperCollectionBenchmarkRunner`` (frozen benchmark,
...
PROVENANCE_NOTE = (
    "Demo Replay fixture generated by the real PaperCollectionBenchmarkRunner "
...
def build_demo_collection() -> PaperCollection:
    ...
    pipeline = PaperCollectionBenchmarkRunner(
        benchmark=benchmark,
