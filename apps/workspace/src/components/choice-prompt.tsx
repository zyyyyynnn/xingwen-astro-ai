import { Button, Input, RadioGroup, RadioGroupItem } from "@xingwen/ui";
...
export function ChoicePrompt({
      ...
      >
        ...
        <p className="xw-choice-prompt__summary">
          <span className="xw-choice-prompt__answer">
            已选择：{answeredFree ? (freeText ?? "") : selectedOption}
          </span>
        </p>
      </div>
    );
  ...
  return (
    ...
    >
      <p className="xw-choice-prompt__question">{question}</p>
      {description ? (
        <p className="xw-choice-prompt__description">{description}</p>
      ) : null}
      <RadioGroup
        ...
        {normalized.map((option, index) => {
          ...
          return (
            ...
            >
              ...
              {option.recommended ? (
                <span className="xw-choice-prompt__recommendation">推荐</span>
              ) : null}
            </label>
          );
        })}
