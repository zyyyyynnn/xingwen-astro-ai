...
class PaperSummaryPipeline:
    ...
    def admit_document(
        ...
        *,
        ...
        """Admit one DocumentParse-backed seven-section summary."""
...
def _admit_evidence(
    *,
    ...
    payload = {
        ...
        "paper": paper.model_dump(mode="json"),
        "benchmark": (
            benchmark.model_dump(mode="json") if benchmark is not None else None
        ),
...
def _validate_evidence_candidate(
    *,
    ...
    if candidate.locator.source_url is None:
        return None, None
    ...
    *, paper_collection: PaperCollection, paper_collection_version_id: str
    ...
    return PaperSummaryInputVersions(
        collection=PaperSummaryCollectionReference(
            artifact_version_id=paper_collection_version_id,
            schema_version=paper_collection.schema_version,
            output_hash=paper_collection.output_hash,
        ),
