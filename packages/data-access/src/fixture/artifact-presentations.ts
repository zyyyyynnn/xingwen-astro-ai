    ...
    graph_edges: [
      {
        ...
        evidence_ids: ["ev_artv_graph_01_edge_01"],
      },
      {
        key: "edge_02",
        kind: "provides_field",
        ...
        target_key: "node_dataset_01",
        evidence_ids: ["ev_artv_graph_01_edge_02"],
      },
      {
        key: "edge_03",
        kind: "derived_from",
        ...
        evidence_ids: ["ev_artv_graph_01_edge_03"],
      },
      {
        key: "edge_04",
        kind: "derived_from",
        ...
        evidence_ids: ["ev_artv_graph_01_edge_04"],
      },
      {
        key: "edge_05",
        kind: "derived_from",
        ...
        evidence_ids: ["ev_artv_graph_01_edge_05"],
      },
      {
        key: "edge_06",
        kind: "supports",
        ...
        evidence_ids: ["ev_artv_graph_01_edge_06"],
      },
      {
        key: "edge_07",
        kind: "supports",
        ...
        evidence_ids: ["ev_artv_graph_01_edge_07"],
      },
      {
        key: "edge_08",
        kind: "supports",
        ...
        evidence_ids: ["ev_artv_graph_01_edge_08"],
      },
      {
        key: "edge_09",
        kind: "hosts",
        ...
        target_key: "node_planet_toi1233_01",
        evidence_ids: ["ev_artv_graph_01_edge_09"],
      },
      {
        key: "edge_10",
        kind: "hosts",
        source_key: "node_star_tic2606",
        target_key: "node_planet_toi1233_02",
        evidence_ids: ["ev_artv_graph_01_edge_10"],
      },
      {
        key: "edge_11",
        ...
        evidence_ids: ["ev_artv_graph_01_edge_11"],
      },
      {
        key: "edge_12",
        kind: "supports_finding",
        ...
        evidence_ids: ["ev_artv_graph_01_edge_12"],
      },
      {
        key: "edge_13",
        kind: "supports_finding",
        ...
        evidence_ids: ["ev_artv_graph_01_edge_13"],
      },
      {
        key: "edge_14",
        kind: "supports_finding",
        ...
        evidence_ids: ["ev_artv_graph_01_edge_14"],
      },
      {
        key: "edge_15",
        kind: "supports_finding",
        ...
        evidence_ids: ["ev_artv_graph_01_edge_15"],
      },
      {
        key: "edge_16",
        kind: "observes",
        source_key: "node_dataset_01",
        target_key: "node_star_tic2606",
        evidence_ids: ["ev_artv_graph_01_edge_16"],
      },
      {
        key: "edge_17",
        kind: "observes",
        source_key: "node_dataset_01",
        target_key: "node_planet_toi1233_01",
        evidence_ids: ["ev_artv_graph_01_edge_17"],
      },
      {
        key: "edge_18_rel_01",
        ...
        target_key: "node_claim_02",
        evidence_ids: ["ev_artv_graph_01_edge_18_rel_01"],
      },
      {
        key: "edge_19_rel_02",
        ...
        source_key: "node_claim_01",
        target_key: "node_claim_03",
        evidence_ids: ["ev_artv_graph_01_edge_19_rel_02"],
      },
    ],
  },
  artv_b_analysis_01: {
