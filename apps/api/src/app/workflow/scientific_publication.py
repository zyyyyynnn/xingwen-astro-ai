"""Publisher commit port for scientific Workflow step outputs."""
...
class ScientificStepPublisher:
    """Admit, ledger and atomically publish one complete scientific Step."""
    ...
    def publish(
        ...
        *,
        ...
        return self._publisher.publish_step_outputs(
            attempt.run_id,
            step_key=step_key,
            attempt_id=attempt.attempt_id,
            token=lease.token,
...
__all__ = ["ScientificStepPublisher"]
