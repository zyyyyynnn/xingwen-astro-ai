  ...
  return Object.freeze({
    ...
    researchInputs: (projectId: DomainEntityId) =>
      queryOptions({
        ...
        queryFn: async (): Promise<readonly ResearchInputRef[]> =>
          repositories.researchInputs.listByProject(projectId),
      }),
    ...
    scientificArtifact: (
      ...
      queryOptions({
        ...
        queryFn: async (): Promise<ScientificArtifactReview> => {
          ...
          if (artifact.artifactVersionId !== artifactVersionId) {
