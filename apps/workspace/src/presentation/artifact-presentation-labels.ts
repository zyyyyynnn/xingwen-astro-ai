...
const ARTIFACT_KIND_DESCRIPTIONS = {
  ...
  analysis_report: "呈现科学技能产出的指标、结果与结论。",
  visualization: "呈现图表、天图与影像等可视化结果。",
  spectrum: "保存光谱数据与谱线测量结果。",
  light_curve: "保存光变数据与周期分析结果。",
  model_evaluation: "记录模型训练、评估指标与诊断。",
  model_artifact: "保存可复用的模型与训练说明。",
