...
def test_claim_prompt_is_hash_pinned_and_schema_aligned() -> None:
    ...
    assert record.content_hash == (
        "sha256:ab64ad3c1da0d41876a81aac630523600e4435c6f7935d9253481a6dadedaffd"
    )
...
def test_valid_claim_is_fully_traceable_and_publisher_ready() -> None:
    ...
    assert candidate.producer.prompt_version == "1.1.0"
    ...
    changed_version = _admit(
        ...
        versions={
            _persisted_uuid("paper-summary.revision-2"): (
                PaperSummaryArtifactVersionInput(
                    artifact_version_id=_persisted_uuid("paper-summary.revision-2"),
...
def test_prompt_definition_change_changes_input_and_output_hashes(
    ...
    assert first.producer.prompt_version == "1.1.0"
